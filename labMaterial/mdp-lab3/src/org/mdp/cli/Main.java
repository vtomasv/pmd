	...
	public static void main(String[] args) {
		try {
			if (args.length < 1) {
				...
				sb.append("\n\t"+StartRegistryAndServer.class.getSimpleName()+": Start a registry and a generic server");
				sb.append("\n\t"+DistributedNgramCountApp.class.getSimpleName()+": Run a instant messaging service");
