...
public class UserDirectoryServer implements UserDirectoryStub {
	...
	private final Map<String,User> directory;
	 ...
	 */
	public synchronized boolean createUser(User u) {
	 ...
	 */
	public synchronized Map<String, User> getDirectory() {
		return directory;
	}
	 ...
	 */
	public synchronized User removeUserWithName(String un) {
